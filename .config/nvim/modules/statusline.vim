...
setlocal statusline=%#StslineSecColorBG#\ INACTIVE\ %#StslineSecColorBG#%{get(b:,'coc_git_statusline',b:GitBranch)}%{get(b:,'coc_git_blame','')}%#StslineBackColorFGSecColorBG#%#StslineBackColorBG#\ %{&readonly?\"\ \":\"\"}%F\ %#StslineModColorFG#%{&modified?\"\ \":\"\"}%=%#StslineBackColorBG#\ %{b:FiletypeIcon}%{&filetype}\ %#StslineSecColorFGBackColorBG#噏%#StslineSecColorBG#\ %p\%%\ %l/%L\ :%c\ 
 
else
setlocal statusline=%#StslineSecColorBG#%{get(b:,'coc_git_statusline',b:GitBranch)}%{get(b:,'coc_git_blame','')}%#StslineBackColorFGSecColorBG#%#StslineBackColorBG#\ %{&readonly?\"\ \":\"\"}%F\ %#StslineModColorFG#%{&modified?\"\ \":\"\"}%=%#StslineBackColorBG#\ %{b:FiletypeIcon}%{&filetype}\ %#StslineSecColorFGBackColorBG#噏%#StslineSecColorBG#\ %p\%%\ %l/%L\ :%c\ 
endif
...
let b:FiletypeIcon = '焅 '
 
elseif &filetype == 'html'
let b:FiletypeIcon = '媙 '
 
elseif &filetype == 'scss'
let b:FiletypeIcon = '响 '
 
elseif &filetype == 'css'
let b:FiletypeIcon = ' '
 
elseif &filetype == 'javascript'
let b:FiletypeIcon = '㘾 '
 
elseif &filetype == 'javascriptreact'
let b:FiletypeIcon = '貟 '
 
elseif &filetype == 'markdown'
let b:FiletypeIcon = '埝 '
 
elseif &filetype == 'sh' || &filetype == 'zsh'
let b:FiletypeIcon = '蚠 '
 
elseif &filetype == 'vim'
let b:FiletypeIcon = '輰 '
...
let b:FiletypeIcon = '嬫 '
 
elseif &filetype == 'cpp'
let b:FiletypeIcon = '㛵 '
 
elseif &filetype == 'c'
let b:FiletypeIcon = '洅 '
 
elseif &filetype == 'go'
let b:FiletypeIcon = ' '
 
elseif &filetype == 'lua'
let b:FiletypeIcon = '娡 '
 
elseif &filetype == 'haskel'
let b:FiletypeIcon = '瑃 '
 
else
let b:FiletypeIcon = 'ぢ '
